...
export default ({ config }: ConfigContext): ExpoConfig => ({
  ...
  ios: {
    ...
    buildNumber: '1',
    infoPlist: {
      NSCameraUsageDescription: 'Enatbet needs camera access to upload property photos',
      NSPhotoLibraryUsageDescription: 'Enatbet needs photo library access to select property images',
